...
menu = [("PacBio m54238_180628_014238", "pacbio_m54238_180628_014238"),
        ("PacBio m54238_180903_015530", "pacbio_m54238_180903_015530"),
        ("PacBio m54238_180901_011437", "pacbio_m54238_180901_011437"),
        ("PacBio m54238_180902_013549", "pacbio_m54238_180902_013549"),
        ("PacBio m64011_181218_235052", "pacbio_m64011_181218_235052"),
        ("PacBio m64011_181227_224151", "pacbio_m64011_181227_224151"),
        ("Illumina D1_S1_L001_R1_001", "illumina_D1_S1_L001_R1_001"),
        ("Illumina D1_S1_L001_R1_002", "illumina_D1_S1_L001_R1_002"),
        ("Illumina D1_S1_L001_R1_003", "illumina_D1_S1_L001_R1_003"),
        ("Illumina D1_S1_L001_R1_004", "illumina_D1_S1_L001_R1_004"),
        ("Illumina MPHG002_S1_L001_R1_001", "illumina_MPHG002_S1_L001_R1_001"),
        ("Illumina MPHG002_S1_L001_R2_001", "illumina_MPHG002_S1_L001_R2_001"),
...
def modify_doc(doc):
    ...
    def on_dropdown_change(event):
        ...
        if datasets[DATASET].nanopore:
            ...
            doc.add_root(column(
                children=[plotter.ci_plot, Spacer(height=50), plotter.barplot,
                          row(Spacer(width=20), barplot_button_group), Spacer(height=50), column(plotter.kmer_plot,
                                                                                                 radio_button_group,
                                                                                                 bin_slider,
                                                                                                 refresh_button),
                          plotter.data_table]))
    ...
    common_plots = column(
        children=[Spacer(height=10), row(Spacer(width=250), dropdown), Spacer(height=10), plotter.lineplot,
                  Spacer(height=50), plotter.gc_plot, Spacer(height=50)])
